...
def check_registration_day_and_time(day, hour):
    for xpath in range(1, 49, 2):
        text = driver1.find_element_by_xpath(f'//*[@id="mainContent"]/div[2]/div[7]/div[{xpath}]/div/div/h4').text.split()
...
def order(day, hour):
    ...
    #check gym slot
    xpath = check_registration_day_and_time(day, hour)
...
if __name__ == '__main__':
    print("Only timeslots within 48 hours are available for registration.")
    user_input = input('Please enter the day and hour of the slot you want. For Friday, 9:45 AM, enter "Friday 9". ').split()
